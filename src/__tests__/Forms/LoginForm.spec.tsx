...
describe("Login Form Component", () => {
  it("renders the form", () => {
    render(<LoginForm loginUser={jest.fn()} loginWithGoogle={jest.fn()} />);
  ...
  it("renders the submit button", () => {
    const Form = render(
      <LoginForm loginUser={jest.fn()} loginWithGoogle={jest.fn()} />
    );
  ...
  it("calls the loginUser function when submitted", () => {
    ...
    const Form = render(
      <LoginForm loginUser={loginUser} loginWithGoogle={jest.fn()} />
    );
    const buttonElement = Form.getByRole("button", { name: /Login/i });
